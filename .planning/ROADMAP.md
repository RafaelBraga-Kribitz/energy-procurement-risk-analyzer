...
- [x] 06-07-PLAN.md — T5.07 make analyze + AN-70x + BUILD_LOG
...
- [x] 07-02-PLAN.md — T6.02 calibration anchors ST-201..204
...
- [x] 07-07-PLAN.md — T6.07 forward cells + ADR-014/015
- [x] 07-08-PLAN.md — T6.08 SSOT generator + ADR-016
- [x] 07-09-PLAN.md — T6.09 GV-303 checker + CI job 4
- [x] 07-10-PLAN.md — T6.10 goldens, Makefile, BUILD_LOG
